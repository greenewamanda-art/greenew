...
export const metadata: Metadata = {
  ...
  description:
    "Entre em contato com a GreenewTelefone : +55 11 98564 4535 Endereço : Rua Jericó, 193 – cj. 32 – Vila Madalena São Paulo/SP - Brasil E-mail : atendimento@greenewgroup.com",
  openGraph: {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-brand-green-deep pt-10 lg:pt-[120px] pb-[40px] relative lg:mt-[80px]">
        <div className="max-w-[1140px] mx-auto px-6 relative z-10">
          <TextAnimate
            className="text-white text-2xl sm:text-3xl lg:text-3xl font-avant font-medium text-left"
            animation="slideLeft"
            by="character"
            duration={1}
            as="h1"
      ...
      <div
        className="min-h-[150px] sm:min-h-[300px]"
        style={{
      ...
      <section className="relative min-h-[800px] bg-brand-brown">
        {/* Brown overlay */}
        <div
          className="absolute inset-0"
          style={{
            backgroundColor: "#CAC898",
            opacity: 0.9,
          }}
        />
        ...
        <div className="relative z-10 flex flex-col items-start lg:flex-row min-h-[800px] pb-56 sm:pb-72 lg:pb-0">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center p-4 lg:-mt-20">
            ...
            {/* Contact Information */}
            <div className="text-white space-y-2 font-avant font-medium">
              ...
              <p className="text-lg flex items-center gap-2">
                ...
                +55 11 98564-4535 - Marina Porchat
              </p>
              <p className="text-lg flex items-center gap-2">
                <svg
                  width="28"
                ...
                Rua Jericó, 193 - CJ 32 - Vila Madalena
                <br className="hidden sm:block"></br> São Paulo / SP - Brasil
              </p>
            </div>
          ...
          <div className="absolute bottom-7 w-full flex -z-1">
            ...
            <div className="w-full lg:w-1/2 flex items-start justify-left"></div>
          </div>
        </div>
      </section>
