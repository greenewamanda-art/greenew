...
export default function AgencySection() {
  return (
    <>
      <div className="w-full px-6 py-14 flex items-center justify-between relative lg:hidden">
        <TextAnimate
          as="h2"
          animation="fadeIn"
          by="line"
        ...
        <Image src="/home/square-mobol.png" alt="Mobol" width={160} height={160} className="w-[160px] h-[160px] right-0 top-0 absolute" />
      </div>
      <section
        id="agencia"
        className="relative flex flex-col gap-8 overflow-hidden bg-brand-cream px-6 py-14 sm:px-10 lg:block lg:h-[calc(940*var(--u))] lg:px-0 lg:py-0"
      >
        ...
        <TextAnimate
          ...
          animation="fadeIn"
          by="line"
          className={`relative z-10 text-brand-olive tracking-[10.8px] ${sectionTitle} lg:absolute lg:left-[calc(203*var(--u))] lg:top-[calc(147*var(--u))] hidden lg:block`}
        >
          AGÊNCIA
        </TextAnimate>
        ...
        <Image
          ...
          width={1334}
          height={1313}
          className="relative hidden lg:block h-[220px] w-full object-cover sm:h-[315px] lg:absolute lg:left-[calc(186*var(--u))] lg:top-[calc(350*var(--u))] lg:h-[calc(315*var(--u))] lg:w-[calc(320*var(--u))]"
        />
      </section>
    </>
  );
