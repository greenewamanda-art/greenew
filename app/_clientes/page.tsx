...
export const metadata: Metadata = {
  ...
  description:
    "Nosso principal ativo, fruto do nosso bom trabalho. Sabemos que a propaganda é a alma do negócio, ainda mais quando a comunicação é integrada para gerar resultados surpreendente",
  openGraph: {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-brand-green-deep pt-10 lg:pt-[120px] pb-[40px] relative lg:mt-[80px]">
        <div className="max-w-[1140px] mx-auto px-6 relative z-10">
          <TextAnimate
            className="text-white text-2xl sm:text-3xl lg:text-3xl font-medium text-left"
            animation="slideLeft"
            by="character"
            duration={1}
            as="h1"
          ...
          <h2 className="text-right text-[40px] sm:text-[70px] lg:text-[100px] stroke font-avant absolute right-2 -bottom-[60px] sm:right-[50px] sm:-bottom-[80px]">
            Clientes
          </h2>
        </div>
      </section>
      ...
      <section className="bg-brand-brown py-20">
        <div className="max-w-[1140px] mx-auto px-6">
          <p className="text-white text-center font-avant text-lg leading-[2] font-medium max-w-[1027px] mx-auto">
            Nosso principal ativo, fruto do nosso bom trabalho. Sabemos que a
            propaganda é a alma do negócio, ainda mais quando a comunicação é
            integrada para gerar resultados surpreendentes. Nosso grande
            objetivo é superar a expectativa de nossos clientes. Os resultados
            são os frutos do nosso trabalho.
          </p>
      ...
      <section className="bg-brand-green-deep py-16 lg:py-24">
        <div className="max-w-[1140px] mx-auto px-6">
          {/* Row 1 */}
