    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-brand-green-deep pt-10 lg:pt-[120px] pb-[40px] relative lg:mt-[80px]">
        <div className="max-w-[1140px] mx-auto px-6 relative z-10">
          <TextAnimate
            className="sm:max-w-[570px] text-white text-[20px] sm:text-3xl lg:text-3xl font-avant font-medium text-left"
            animation="slideLeft"
            by="character"
            duration={1}
            as="h1"
          ...
          <h2 className="text-right text-[34px] sm:text-[70px] lg:text-[100px] stroke font-avant absolute right-3 -bottom-[80px] sm:-right-[10px] sm:-bottom-[210px]">
      ...
      {/* Tree Section */}
      <section
        className="relative bg-brand-green-deep py-12 sm:py-16 lg:py-20 min-h-[200px] sm:min-h-[300px] lg:min-h-[400px]"
        style={{
      ...
      {/* Content Section */}
      <section className="bg-brand-brown py-12 sm:py-16 lg:py-20">
        <div className="max-w-[1140px] mx-auto px-6 text-center">
          <div className="text-white space-y-4 sm:space-y-6 mb-8 sm:mb-12">
            <p className="text-sm font-avant leading-relaxed sm:max-w-[691px] sm:mx-auto font-medium">
              Nosso compromisso em atender à crescente necessidade de revisar
              padrões vigentes para que o sucesso seja alcançado ponderando-se
              os impactos sociais e ambientais consequentes da atuação da
              empresa.
            </p>

            <div className="text-sm leading-relaxed font-avant font-medium  sm:max-w-[700px] sm:mx-auto">
              <p>
                Apoiamos iniciativas como: <br></br>
              </p>
              ...
              <p>
                Realizamos o plantio de árvores em áreas de proteção ambiental:
                APA Baia de Camamu, Taipu de Fora, Bahia e APA Serra do Itaí,
                Tapirai, São Paulo.
              </p>
            </div>
          </div>
          ...
          {/* Partner Logos */}
          <div
            className="bg-white p-4 sm:p-6 lg:p-3 rounded-lg inline-block w-full max-w-2xl 
          ...
          >
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-12">
              ...
              <div className="flex items-center justify-center">
                <Image
                  className="w-[203px]"
                  src="logo-medicos-sem-fronteiras.png"
                  alt=""
                  width={225}
                  height={196}
                />
